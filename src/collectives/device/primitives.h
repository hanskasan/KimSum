...
struct PrimitivesWithoutDirect {
  ...
  __device__ void directRecv(intptr_t outIx, int eltN, bool is_drop=false) {
    static_cast<RealPrimitives*>(this)->recv(outIx, eltN, is_drop, /*postOp=*/false);
  }
  ...
  __device__ void directRecvCopySend(intptr_t outIx, intptr_t remoteOutIx, int eltN, bool is_drop=false) {
    static_cast<RealPrimitives*>(this)->recvCopySend(outIx, eltN, is_drop, /*postOp=*/false);
  }
  __device__ void directRecvReduceCopySend(intptr_t inpIx, intptr_t outIx, intptr_t remoteOutIx, int eltN, int step, bool is_drop=false, bool postOp=false) {
    // Direct is only for the send part
    static_cast<RealPrimitives*>(this)->recvReduceCopySend(inpIx, outIx, eltN, step, is_drop, postOp);
  }
};
